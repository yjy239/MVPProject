 ...
 */
public class StudyTextPresentImpl extends BasePresenter<StudyTextContract.StudyTextView> implements StudyTextContract.StudyTextPresent {

    private StudyTextContract.StudyTextView mView;
    private List<Visitable> list = new ArrayList<>();

    //构造函数设置present
    public StudyTextPresentImpl(StudyTextContract.StudyTextView mView) {
        this.mView = mView;
