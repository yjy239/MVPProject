 ...
 */
public class StudyMovieListHolder extends BaseContextViewHolder<StudyMovieListBean> {

    public StudyMovieListHolder(View itemView, Context context) {
        super(itemView, context);
    }

    @Override
    public void setUpView(final StudyMovieListBean model, final int position, final MultiTypeAdapter adapter) {
