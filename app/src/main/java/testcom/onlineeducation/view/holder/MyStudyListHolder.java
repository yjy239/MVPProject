 ...
 */
public class MyStudyListHolder extends BaseContextViewHolder<MyStudyBean> {
    ...
    public MyStudyListHolder(View itemView, Context context) {
        super(itemView, context);
    }

    @Override
    public void setUpView(MyStudyBean model, int position, MultiTypeAdapter adapter) {
