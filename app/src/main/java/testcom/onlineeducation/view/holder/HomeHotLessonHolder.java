...
import testcom.onlineeducation.ui.Activity.Detailed.LessonDetailActivity;
 ...
 */
public class HomeHotLessonHolder extends BaseContextViewHolder<HomeHotLessonBean> {
    public HomeHotLessonHolder(View itemView, Context context) {
        super(itemView, context);
    }

    @Override
    public void setUpView(final HomeHotLessonBean model, final int position, final MultiTypeAdapter adapter) {
...
//                .transform(new GlideCircleTransform(this.context))
                .into(iv);
        getView(R.id.item).setOnClickListener(new View.OnClickListener() {
            @Override
